        ...
        <Svg
          ...
          <Defs>
            <LinearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
              <Stop offset="0%" stopColor={shade200} />
              <Stop offset="50%" stopColor={shade300} />
              <Stop offset="100%" stopColor={shade400} />
            </LinearGradient>
          </Defs>
          <Path
    ...
    return (
      <View
        ...
        <View
          ...
          <Icon name="solar:key-bold" size={width * 0.5} color={foreground} />
        </View>
      </View>
    );
