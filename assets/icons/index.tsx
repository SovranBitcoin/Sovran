    ...
    <Svg width="150" height="150" viewBox="0 0 158 158" fill="none">
      <Defs>
        <LinearGradient id="gradient2" x1="0%" y1="0%" x2="100%" y2="0%">
          <Stop stopOpacity={0} offset="0%" stopColor={getPrimaryColor('800')} />
          <Stop stopOpacity={1} offset="100%" stopColor={getPrimaryColor('700')} />
        </LinearGradient>
      </Defs>
      <Path
    ...
    case 'euro':
      return (
        <Svg width="64" height="64" viewBox="0 0 48 48">
          <Defs>
            <LinearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%">
              <Stop offset="0%" stopColor={getPrimaryColor('50')} />
              <Stop offset="100%" stopColor={getPrimaryColor('100')} />
            </LinearGradient>
          </Defs>
          <Path
            fill="none"
...
export function BtcIcon({
  ...
  return <Icon name={iconName} color={color || getPrimaryColor('0')} size={size * 1.2} />;
}
