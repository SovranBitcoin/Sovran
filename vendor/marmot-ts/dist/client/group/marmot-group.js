import { bytesToHex, getEventHash, } from "applesauce-core/helpers/event";
import { EventEmitter } from "eventemitter3";
import { contentTypes, createApplicationMessage, createCommit, createProposal, defaultProposalTypes, defaultCryptoProvider, processMessage, wireformats, } from "ts-mls";
...
export class MarmotGroup extends EventEmitter {
    ...
    async inviteByKeyPackageEvent(keyPackageEvent) {
        ...
        if (keyPackageEvent.kind !== 443) {
            throw new Error(`inviteByKeyPackageEvent: Expected KeyPackage event kind 443, got ${keyPackageEvent.kind}`);
        }
