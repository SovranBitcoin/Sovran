/**
 * @fileoverview Canonical Lightning send route shell
 *
 * Single body for the Lightning send expo-router files. The active
 ...
 * transactions-flow re-entries leave them undefined so `LightningSendScreen`
...
interface LightningSendRouteProps {
  /** Log scope for invalid-params telemetry; e.g. `'send-flow.lightningSend'`. */
  where: string;
  /**
