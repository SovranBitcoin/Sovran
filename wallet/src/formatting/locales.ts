...
const en: TranslationMap = {
  ...
  TESTNUT_ACCOUNT_MISMATCH: 'Test mint funds stay separate from real funds',
...
const ar: TranslationMap = {
  ...
  TESTNUT_ACCOUNT_MISMATCH: 'تبقى أموال دار السك التجريبية منفصلة عن الأموال الحقيقية',
...
const de: TranslationMap = {
  ...
  TESTNUT_ACCOUNT_MISMATCH: 'Guthaben von Test-Mints bleibt von echtem Guthaben getrennt',
