...
export type PaymentCopyKey =
  ...
  | "timeline.melt.rolledBack.label"
  | "timeline.melt.rolledBack.info"
  | "timeline.melt.onchain.sending.label"
  | "timeline.melt.onchain.sending.info"
  | "timeline.melt.onchain.sent.label"
  | "timeline.melt.onchain.broadcasting.label"
  | "timeline.melt.onchain.broadcasting.info"
  | "timeline.melt.onchain.mempool.label"
  | "timeline.melt.onchain.blocks"
  | "timeline.melt.onchain.confirmed.label"
  | "timeline.melt.onchain.offchain.label"
  | "timeline.melt.onchain.offchain.info"
