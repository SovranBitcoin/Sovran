...
export type PaymentCopyKey =
  ...
  | "timeline.send.locked.label"
  | "timeline.send.locked.info"
  | "timeline.send.unlock.label"
  | "timeline.send.unlock.reachedLabel"
  | "timeline.send.rolledBack.reclaimedLabel"
  | "timeline.send.unlock.infoUpcoming"
  | "timeline.send.unlock.infoRefund"
  | "timeline.send.unlock.infoPublic"
  ...
  | "header.lightningSend.ready"
  | "header.lightningSend.inFlight"
  | "header.lightningSend.settled"
  | "header.lightningSend.cancelled"
  | "header.lightningSend.failed"
  | "header.lightningSend.expired"
  | "header.onchainSend.ready"
  | "header.onchainSend.inFlight"
  | "header.onchainSend.settled"
  | "header.onchainSend.cancelled"
  | "header.onchainSend.failed"
  | "header.onchainSend.expired"
  | "header.ecashSend.ready"
  | "header.ecashSend.inFlight"
  | "header.ecashSend.settled"
  | "header.ecashSend.cancelled"
  | "header.ecashSend.failed"
  | "header.ecashSend.expired"
  | "header.lightningReceive.ready"
  | "header.lightningReceive.inFlight"
  | "header.lightningReceive.settled"
  | "header.lightningReceive.cancelled"
  | "header.lightningReceive.failed"
  | "header.lightningReceive.expired"
  | "header.onchainReceive.ready"
  | "header.onchainReceive.inFlight"
  | "header.onchainReceive.settled"
  | "header.onchainReceive.cancelled"
  | "header.onchainReceive.failed"
  | "header.onchainReceive.expired"
  | "header.ecashReceive.ready"
  | "header.ecashReceive.inFlight"
  | "header.ecashReceive.settled"
  | "header.ecashReceive.cancelled"
  | "header.ecashReceive.failed"
  | "header.ecashReceive.expired"
  | "header.swap.ready"
  | "header.swap.inFlight"
  | "header.swap.settled"
  | "header.swap.cancelled"
  | "header.swap.failed"
  | "header.swap.expired"
  | "header.payPerson.ready"
  | "header.payPerson.inFlight"
  | "header.payPerson.settled"
  | "header.payPerson.cancelled"
  | "header.payPerson.failed"
  | "header.payPerson.expired"
  | "header.receivePerson.ready"
  | "header.receivePerson.inFlight"
  | "header.receivePerson.settled"
  | "header.receivePerson.cancelled"
  | "header.receivePerson.failed"
  | "header.receivePerson.expired";
