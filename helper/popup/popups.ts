...
export const showMessage = (
  ...
  const text =
    typeof config.text === "function" ? config.text(params) : config.text;
...
export const showSuccess = (
  ...
  showMessage(
    messageCode,
    params,
    { ...options, type: MESSAGE_TYPES.SUCCESS },
    onClose
  );
...
export const showError = (
  ...
  showMessage(
    messageCode,
    params,
    { ...options, type: MESSAGE_TYPES.ERROR },
    onClose
  );
...
export const showWarning = (
  ...
  showMessage(
    messageCode,
    params,
    { ...options, type: MESSAGE_TYPES.WARNING },
    onClose
  );
...
export const showInfo = (
  ...
  showMessage(
    messageCode,
    params,
    { ...options, type: MESSAGE_TYPES.INFO },
    onClose
  );
