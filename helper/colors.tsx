  ...
  switch (t) {
    ...
    default: {
      return {
        ...
        100: '#E8EAED', // RGB(232, 234, 237)
        200: '#C7C7C7', // RGB(199, 199, 199)
        400: '#A8A8A8', // RGB(168, 168, 168)
        600: '#787878', // RGB(120, 120, 120)
        700: '#525252', // RGB(82, 82, 82)
        1000: '#393939', // RGB(57, 57, 57)
        1200: '#2C2C2C', // RGB(44, 44, 44)
        1300: '#202020', // RGB(32, 32, 32)
        1400: '#232323', // RGB(35, 35, 35)
        1500: '#1C1C1C', // RGB(28, 28, 28)
        1800: '#181818', // RGB(24, 24, 24)
        1900: '#101010', // RGB(16, 16, 16)
        2000: '#121212', // RGB(18, 18, 18)
        2100: '#0C0C0C', // RGB(12, 12, 12)
        2300: '#080808', // RGB(6, 6, 6)
        // 2300: "#000000", // RGB(0, 0, 0)
      };
    }
  }
};
