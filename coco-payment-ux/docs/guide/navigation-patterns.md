...
How coco-payment-ux routes users through payment flows — and how this differs from other Cashu wallets.
...
**coco-payment-ux takes a different approach.** Instead of asking the user to choose a protocol upfront, the library infers the correct flow from context:
...
| Aspect             | Dropdown (eNuts, Minibits)        | Intent-based (coco-payment-ux)            |
| ------------------ | --------------------------------- | ----------------------------------------- |
