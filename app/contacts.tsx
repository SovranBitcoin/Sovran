...
function ModalScreen() {
  ...
  const skeletonBgColor = theme.greys[1800];
  const skeletonHighlightColor = theme.greys[1300];
                ...
                <View style={{ flex: 1, position: 'relative' }}>
                  ...
                  <RNTextInput
                    ...
                    style={{
                      flex: 1,
                      paddingRight: 30,
                      backgroundColor: theme.greys[1800], // Add background color
                  ...
                  {searchQuery.length > 0 && (
                    <TouchableOpacity
                      ...
                      <Icon name="simple-line-icons:close" size={20} color={theme.greys[100]} />
                    </TouchableOpacity>
                  )}
                </View>
  ...
  return (
    <View
      ...
      <View
        ...
        <Icon name="nonicons:error-16" size={40} color={theme.greys[700]} />
      </View>
      ...
      <View
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 8 }}>
          <Icon name="lucide:pencil-line" size={20} color={theme.greys[600]} />
          <Text style={{ color: theme.greys[400], fontSize: 14, flex: 1, paddingLeft: 8 }}>
            Check your spelling
          </Text>
        </View>
        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 8 }}>
          <Icon name="solar:key-bold" size={20} color={theme.greys[600]} />
          <Text style={{ color: theme.greys[400], fontSize: 14, flex: 1, paddingLeft: 8 }}>
            Try using a complete public key
          </Text>
        </View>
        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 8 }}>
          <Icon name="mdi:at" size={20} color={theme.greys[600]} />
          <Text style={{ color: theme.greys[400], fontSize: 14, flex: 1, paddingLeft: 8 }}>
  ...
  return (
    <View
      ...
      <View
        ...
        <Icon name="majesticons:search-line" size={40} color={theme.greys[700]} />
      </View>
      ...
      <View
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 12 }}>
          <Icon name="ph:user-bold" size={20} color={theme.greys[600]} />
          <Text style={{ color: theme.greys[400], fontSize: 14, flex: 1, paddingLeft: 8 }}>
...
function SearchResult({ result, onPress, loading }) {
  ...
  return (
    <TouchableOpacity
      ...
      <View style={{ flex: 1 }}>
        <Text loading={loading} style={{ fontWeight: 'bold', color: theme.greys[100] }}>
        ...
        <>
          {profile?.picture && !imageError ? (
            ...
            <View
              ...
              <Icon name="ph:user-bold" size={24} color={theme.greys[700]} />
            </View>
          )}
        </>
      )}
