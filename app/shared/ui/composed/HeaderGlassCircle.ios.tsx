 ...
 *
 * Same RN-content-inside-SwiftUIButton pattern as BalancePill.liquid. The RN
 * wrapper carries the accessible name, role and state (the SwiftUI button
 * exposes none of them to the JS tree); VoiceOver activation reaches the
 * handler through `onAccessibilityTap`.
 */
export function HeaderGlassCircle({
  ...
  return (
    <View
      ...
      onAccessibilityTap={interactive ? onPress : undefined}>
