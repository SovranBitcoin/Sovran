 ...
 *
 * A SEV-SNP attestation report arrives gzipped inside the bundle, which
 * `@routstr/sdk` verifies before sealing a request to a Tinfoil enclave. The
 * verifier reaches for `DecompressionStream('gzip')` and falls back to `zlib`;
