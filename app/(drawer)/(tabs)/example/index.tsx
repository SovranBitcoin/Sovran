...
export const LayoutDebugWrapper = ({ children, debug = false }: LayoutDebugWrapperProps) => {
  ...
  return (
    <AnimatedBackgroundView>
      {/* Debug overlays - only render when debug is true */}
      {debug && (
        <>
      ...
      <ScrollView
        ...
        {/* Debug info card - only render when debug is true */}
        {debug && (
