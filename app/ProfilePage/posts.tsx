...
export const Posts = React.memo(
  ({ mainPost = [], authors, ids, kinds, type }) => {
    const { posts, replies, media, fetchMore, loading, nextDateRange } =
      useNostrEvents(authors, ids, kinds, type);
        ...
        {loading ? (
          ...
          <View style={{ alignItems: "center", justifyContent: "center" }}>
            ...
            >
              ...
              >
                {new Date(nextDateRange.since * 1000).toLocaleDateString(
                  "en-GB"
                ) +
                  " - " +
                  new Date(nextDateRange.until * 1000).toLocaleDateString(
                    "en-GB"
                  )}
              </Text>
            </TouchableOpacity>
