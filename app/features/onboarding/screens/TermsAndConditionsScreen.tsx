...
THE SOVRAN APP DOES NOT HOLD USERS' ECASH AND DOES NOT EXECUTE AND CANNOT MONITOR TRANSACTIONS. SOVRAN OPERATES SOME MINTS, BUT YOU MAY USE ANY MINT YOU CHOOSE, AND THE CHOICE OF MINT — INCLUDING ANY SOVRAN-OPERATED MINT — AND ALL DUE DILIGENCE ON THAT MINT ARE SOLELY YOUR RESPONSIBILITY.
...
1.1 Non-Custodial Application: Sovran provides a non-custodial application ("wallet") that is executed entirely on your device. Our App merely makes available client-side code implementing the open-source Cashu protocol. We do not run a server that holds your ecash or executes transactions on your behalf; any Mint you connect to, including a Sovran-operated Mint, is a service separate from the wallet App (see Section 1.2).

1.2 Mints and Mint Selection: A Mint is a service, separate from the App, that issues ecash under the Cashu protocol and holds the funds backing the ecash it has issued until that ecash is redeemed. Sovran operates some Mints, which may appear in the App's mint selector. You are never required to use a Sovran-operated Mint: the mint selector lets you choose any Mint you wish, including Mints operated by third parties or by yourself. Whichever Mint you choose — including a Sovran-operated Mint — it is always your responsibility to perform your own due diligence on that Mint before entrusting it with funds. Sovran does not operate or control any Mint other than those it expressly identifies as Sovran-operated, and any transaction or relationship you establish with a Mint is solely between you and that Mint.

1.3 No Funds Access Through the App: At no time does the App give Sovran custody, possession, or control of your ecash. Your ecash is stored locally on your device, and transactions occur solely by your actions and through your chosen Mint. Note that under the Cashu protocol any Mint — including a Sovran-operated Mint, if you choose to use one — holds the funds backing the ecash it has issued. The App does not monitor, verify, or facilitate transfers between you and any Mint or other parties.

1.4 Server Operations: Sovran does not operate any servers relating to your ecash except the Sovran-operated Mints described in Section 1.2 and servers providing functionality to purchase eSIMs. The application is executed entirely on your device. Once the code is served, all logic executes locally and Sovran has no control over the application.
...
1.6 Code Disclaimer and Verification: The open-source code is provided without any guarantee of security, error-free operation, or technical support. Users must independently verify the authenticity, security, and integrity of the open-source code prior to use. In particular, because Sovran both publishes the App and operates some Mints, you should verify the source of the App you install to confirm that it stores your ecash locally on your device as described in these Terms.

2. User Responsibilities & Disclaimers

2.1 User's Sole Responsibility: You understand and agree that you use the App and Services at your own risk and for your own account. You alone are fully responsible for selecting Mints — including performing due diligence on any Mint, whether or not it is operated by Sovran — conducting transactions, and safeguarding your ecash and secret values. Sovran is not a party to and disclaims any responsibility for any agreements, terms, or disputes between you and any Mint.

2.2 Mints Are Distinct from the App: Except for Mints that Sovran expressly identifies as Sovran-operated, Sovran is not affiliated with, endorsed by, or responsible for any Mint. We make no representations, warranties, or guarantees about any Mint's integrity, legality, liquidity, or functionality; Sovran-operated Mints are provided "as is" like the rest of the Services. Your relationship with any Mint, including the issuance, redemption, or valuation of ecash, is a matter between you and that Mint in its capacity as a Mint. Sovran the App publisher is not a party to any transaction between you and any third-party Mint or other third party. No agency, partnership, or joint venture relationship is formed by your use of the App.
