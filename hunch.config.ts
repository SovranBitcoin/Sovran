...
// what counts, including the sanctioned exceptions, so a whole-file pass
// (`check --all`) and a diff pass flag the same things. `when` skips hunks
// that cannot be relevant. Configs are evaluated as data: only `const`,
// string `+`, object spread and regex literals are allowed.
...
// Appended to every question: `--all` sends whole files with every line marked
// as added, so questions must be answerable from the visible code alone.
const SCOPE =
  ' Judge only the code visible in `hunk` (it may be a whole file with every line shown as added). Use the visible code, comments and stated contracts; do not assume callers, requirements or behaviour outside the hunk.';
// Appended to every `false` criterion.
const NO_EVIDENCE =
  ' Also false when the hunk has nothing to do with this concern, or when the visible code gives no concrete evidence of it.';
        ...
        'nostr/delivery': [
          ...
          noul({
            ...
            criteria: {
              ...
              false:
                'Separate states are kept and relay OK is recorded as accepted.' + NO_EVIDENCE,
            },
        ...
        'wallet/locks': [
          ...
          noul({
            ...
            criteria: {
              ...
              false: 'Lock failures abort the send and constraints are honoured.' + NO_EVIDENCE,
            },
        ...
        'wallet/mint-trust': [
          ...
          noul({
            ...
            criteria: {
              ...
              false: 'Mint-info failures surface as errors or unknown state.' + NO_EVIDENCE,
            },
        ...
        'cta/pure-eligibility': [
          ...
          noul({
            ...
            criteria: {
              ...
              false: 'Pure synchronous checks over the injected context and clock.' + NO_EVIDENCE,
            },
