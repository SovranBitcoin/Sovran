...
export function SwapTransactionScreen({ groupId }: Props) {
  ...
  // Load mint info for all mint URLs used in the group
      ...
      <View style={styles.container}>
        <VStack spacing={16}>
          ...
          {group.legs.map((leg, idx) => {
            ...
            return (
              <View key={leg.id}>
                {idx > 0 ? <View style={styles.legSpacer} /> : null}
                ...
                <View style={[styles.card, { borderColor }]}>
                  <BlurCardFrame accentColor={accentColor}>
                    <View style={styles.content}>
                      ...
                      {/* Error banner – styled like the separator */}
                      {hasError && leg.errorMessage ? (
                        <View
                          ...
                          <HStack spacing={8} align="center">
                            <Icon name="mdi:alert-circle" size={16} color={getRedColor('400')} />
                            <UntranslatedText
                              size={11}
                              bold
