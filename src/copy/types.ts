...
export type PaymentCopyVariables = Record<string, string | number | boolean | null | undefined>;
...
export interface PaymentCopyResolver {
  ...
  resolve: (key: PaymentCopyKey, variables?: PaymentCopyVariables) => PaymentCopyResult;
}
