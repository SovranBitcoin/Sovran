...
import type { PaymentCopyKey, PaymentCopyResolver, PaymentCopyVariables } from './types';

type PaymentCopyText = (key: PaymentCopyKey, variables?: PaymentCopyVariables) => string;
  ...
  return {
    ...
    RECEIVE_COPY: {
      ...
      redeemed: {
        ...
        info: (amount: number) => text('timeline.receive.redeemed.info', { amount }),
      },
      alreadySpent: {
